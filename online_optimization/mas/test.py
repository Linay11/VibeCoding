...
def test_solve():
    filedir = '/home/ljj/project/mlopt/online_optimization/mas'
    file = filedir + '/mas76.mps'
    sol_file = filedir + '/mas76.sol'
...
def test_setcover():
    STORAGE_DIR = "/home/ljj/project/mlopt/results/mas/setcover"
    mlopt_model_DIR = "/home/ljj/project/mlopt/results/mas/setcover"
    EXAMPLE_NAME = STORAGE_DIR + '/mas_'

    # Load model
    n_best = 20
    m_mlopt = mlopt.Optimizer.from_file(mlopt_model_DIR + '/mas_model')
