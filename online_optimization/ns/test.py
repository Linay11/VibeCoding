...
def test_solve():
    filedir = '/home/ljj/project/mlopt/online_optimization/ns'
    file = filedir + '/ns1830653.mps'
    sol_file = filedir + '/ns1830653.sol'
...
def test_setcover():
    STORAGE_DIR = "/home/ljj/project/mlopt/results/ns/setcover"
    mlopt_model_DIR = "/home/ljj/project/mlopt/results/ns/setcover"
    EXAMPLE_NAME = STORAGE_DIR + '/ns_'

    # Load model
    n_best = 20
    m_mlopt = mlopt.Optimizer.from_file(mlopt_model_DIR + '/ns_model')
