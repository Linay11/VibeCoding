...
def get_instance(sample_name, n_instances, r, ptype='beasley'):
    instace_dir = f'/home/ljj/home/ljj/tmp/pycharm_project_586/instance/test/{ptype}/'
    if not os.path.exists(instace_dir):
        os.makedirs(instace_dir)
    model = gp.read(sample_name)
    variables = model.getVars()
    parameter_indices = range(1250, 1300)
...
filedir = '/home/ljj/project/mlopt/online_optimization/beasley'
file = filedir + '/beasleyC3.mps'
get_instance(file, 100, r=2, ptype='beasley')
