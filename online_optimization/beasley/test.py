...
def test_solve():
    ...
    sol_file = filedir + '/beasleyC3.sol'
...
def test_setcover():
    STORAGE_DIR = "/home/ljj/project/mlopt/results/binkar/setcover"
    mlopt_model_DIR = "/home/ljj/project/mlopt/results/binkar/setcover"
    EXAMPLE_NAME = STORAGE_DIR + '/binkar_'

    # Load model
    n_best = 20
    m_mlopt = mlopt.Optimizer.from_file(mlopt_model_DIR + '/binkar_model')
