...
from mlopt.cluster_filter import Cluster_Filter
...
class Optimizer(object):
    ...
    def get_samples(self, X=None, sampling_fn=None,
                    ...
                    cluster_filter=stg.cluster_FILTER_STRATEGIES):
    ...
    def cluster_filter(self, parallel=True):
        ...
        self._filter = Cluster_Filter(X_train=self.X_train,
                              ...
                              encoding=self.encoding,
                              problem=self._problem)
        self.y_train, self.encoding, self.X_train ,self.obj_train= \
    ...
    def train(self, X=None,
              ...
              filter_strategies=stg.FILTER_STRATEGIES,
              cluster_strategies=stg.cluster_FILTER_STRATEGIES,
              **learner_options):
        """
